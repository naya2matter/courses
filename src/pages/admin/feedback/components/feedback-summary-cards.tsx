...
export function FeedbackSummaryCards({ items, total }: FeedbackSummaryCardsProps) {
  ...
  const withResponse = items.filter((f) => f.admin_response != null).length

  const cards: StatCard[] = [
    { key: "total",        title: "Total",       value: resolvedTotal, icon: MessageSquareIcon, iconColor: "text-indigo-400"  },
    ...
    { key: "responded",    title: "Responded",   value: withResponse,  icon: SparklesIcon,      iconColor: "text-violet-400"  },
  ]
