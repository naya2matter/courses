  ...
  return (
    <Sheet open={open} onOpenChange={(v) => !v && handleClose()}>
      <SheetContent className="w-full sm:max-w-lg overflow-y-auto">
        <SheetHeader>
          <SheetTitle>Edit Attendance Record</SheetTitle>
          <SheetDescription>
        ...
        <div className="mt-6 space-y-5 px-1">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              disabled={isSaving}
              className={validationErrors.clock_in ? "border-destructive" : ""}
            />
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              disabled={isSaving}
              className={validationErrors.clock_out ? "border-destructive" : ""}
            />
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              disabled={isSaving}
              className={validationErrors.rating ? "border-destructive" : ""}
            />
